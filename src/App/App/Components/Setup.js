                ...
                {step === 0 ? (
                    <>
                        <div>
                            ...
                            <p>
                                Welcome to the CampusRoute setup page! We're
                                excited to accompany you on your university
                                journey and provide you with a seamless
                                navigation and organization experience. By
                                setting up CampusRoute, you'll gain access to a
                                comprehensive timetable that displays all your
                                classes, receive real-time directions to your
                                classes, and stay informed with class transition
                                notifications. Our user-friendly interface and
                                helpful features allow you to stay focused on
                                your academic goals.
                            </p>
                        </div>
                        <button
                            ...
                            <>
                                <div>
                                    ...
                                    <div className={styles["setup-error"]}>
                                        ...
                                        <p>
                                            Please note that CampusRoute's beta
                                            testing is currently limited to the
                                            Upper Caboolture region, which
                                            includes Caboolture, Burpengary, and
                                            Narangba.
                                        </p>
                                    </div>
                            ...
                            <>
                                {step === 2 ? (
                                    <>
                                        ...
                                        <MapContainer
                                            center={
                                                selectedSchool.coordinates.array
                                            }
                                            zoom={17}
                                            maxZoom={18}
                                            style={{
                                        ...
                                        >
                                            ...
                                            <Marker
                                                position={
                                                    selectedSchool.coordinates
                                                        .array
                                                }
                                            />
                                        </MapContainer>
                                        <div
                                            className={styles["setup-buttons"]}
                                        >
                                            <button
                                                onClick={() => {
                                                    setStep(step - 1);
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <p>
                                                    ...
                                                    infomation once you finish
                                                    the setup
                                                </p>
                                            </div>
                                            <div
                                                className={
                                                    styles["setup-input-number"]
                                                }
                                            >
                                                <input
                                                    type="number"
